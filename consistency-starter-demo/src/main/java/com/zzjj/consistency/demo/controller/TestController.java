package com.zzjj.consistency.demo.controller;
...
import com.zzjj.consistency.demo.order.SendMessageComponent;
...
public class TestController {
     ...
     * alertExpression(executeTimes % 2 == 0) 告警通知时，会触发消息的推送，并可以调用相关实现类
     */
    @GetMapping("/test")
    public String send() {
        // 模拟插库操作
        ...
        // 发消息操作
        this.sendMessageComponent.send(orderInfoDTO);
        return "ok";
    }
    ...
    public String sendRightNowAsyncMessage() {
        ...
        // 发送立即执行异步任务
        this.sendMessageComponent.sendRightNowAsyncMessage(orderInfoDTO);
        return "ok";
    }
    ...
    public String sendRightNowAsyncMessage1() {
        // 模拟插库操作
        OrderInfoDTO orderInfoDTO = OrderInfoDTO.builder().id("222").build();
        OrderInfoDTO orderInfoDTO1 = OrderInfoDTO.builder().id("333").build();
        ...
        // 发送立即执行异步任务
        this.sendMessageComponent.sendRightNowAsyncMessage(orderInfoDTOArrayList);
        return "ok";
    }
    ...
    public String sendRightNowAsyncMessage2() {
        // 发送立即执行异步任务
        this.sendMessageComponent.sendRightNowAsyncMessage2();
        return "ok";
    }
