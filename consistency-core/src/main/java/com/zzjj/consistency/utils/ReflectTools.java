...
public class ReflectTools {
     ...
     * 初始化基础数据类型的MAP
     */
    private static final HashMap<String, Class<?>> PRIMITIVE_MAP = new HashMap<>() {
        private static final long serialVersionUID = -2169997302101932724L;

        {
            this.put("java.lang.Integer", int.class);
            ...
            this.put("java.lang.Char", char.class);
        }
    };
