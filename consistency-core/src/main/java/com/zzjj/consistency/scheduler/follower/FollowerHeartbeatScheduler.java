...
public class FollowerHeartbeatScheduler {
    ...
    public FollowerHeartbeatScheduler(final ScheduledFuture<?> scheduledFuture) {
    ...
    public String toString() {
        ...
        return "FollowerHeartbeatScheduler还没有执行, 将于" + this.scheduledFuture.getDelay(TimeUnit.MILLISECONDS) + "ms 后执行";
    }
}
